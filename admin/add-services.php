    ...
    <div class="col-xs-12">
        ...
        <div class="box-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="save-add-service.php" method="POST" enctype="multipart/form-data">
                        <div class="padding-10">

                            <div class="margin-top-20">
                                <h5><b>Service Name</b></h5>
                                <textarea id="textarea" class="form-control" maxlength="100" rows="1"
                                    placeholder="This Heading has a limit of 100 chars." name="s_name" required></textarea>
                            </div>
                            ...
                            <!-- <input id="output" type="hidden" name="icon" /> -->


                            <br>
                            <div class="margin-top-20">
                                <h5><b>Image Uplaod</b></h5>
                                <input type="file" id="exampleInputFile" name="s_image" id="image" required>
                                <div id="preview"></div>
                            </div>
