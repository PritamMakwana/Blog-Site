...
<body>
	...
	<div class="main-menu">
		<header class="header">
			<a href="dashboard.php" class="logo">Cyberonion</a>
		...
		<div class="content">
			<div class="navigation">
				...
				<ul class="menu js__accordion">
					<li>
						<a class="waves-effect" href="index.php"><i
								class="menu-icon ti-dashboard"></i><span>Dashboard</span></a>
					</li>
					<li>
						<a class="waves-effect" href="banner.php"><i
								class="menu-icon ti-calendar"></i><span>Banner</span></a>
					</li>
					<li>
						<a class="waves-effect" href="analytics.php"><i
								class="menu-icon ti-layers-alt"></i><span>Analytics</span></a>
					</li>
					<li>
						<a class="waves-effect" href="services.php"><i
								class="menu-icon fa fa-recycle"></i><span>Services</span></a>
					</li>

					<li>
						<a class="waves-effect" href="blog.php"><i
								class="menu-icon fa fa-wpforms"></i><span>Blog</span></a>
					</li>

					<li>
						<a class="waves-effect" href="team.php"><i
								class="menu-icon fa fa-users"></i><span>Team</span></a>
					</li>

					<li>
						<a class="waves-effect" href="faq.php"><i
								class="menu-icon  fa fa-question-circle-o"></i><span>FAQ</span></a>
					</li>
					<li>
						<a class="waves-effect" href="web-setting.php"><i class="menu-icon  fa fa-cog"></i><span>Website
								Setting</span></a>
					</li>
				</ul>
				<!-- 				
